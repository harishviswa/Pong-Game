...
//move method
	...
	/**
	 * Returns true if any part of the Ball is inside the paddle
	 * @param ball the Ball
	 * @return true if any part of the Ball is inside the paddle, false otherwise
	 */
	public boolean inPaddle(Ball ball) {
